This folder includes an executable Unity demo file of the training tool named “CHI_2019_Demo.exe”. The demo is customized for CHI 2019 paper review and only contains three (out of six) of the tasks. To run the file, you should:
